 ...
 * {@link chatday.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link chatday#newInstance} factory method to
 * create an instance of this fragment.
 */
public class chatday extends Fragment implements OnItemSelectedListener {
    ...
    private chatday.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    ImageButton sharechatday;
     ...
     * @return A new instance of fragment chatday.
     */
    // TODO: Rename and change types and number of parameters
    public static chatday newInstance(String param1, String param2) {
        chatday fragment = new chatday();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private chatday.LastTimeUsedComparator mLastTimeUsedComparator = new chatday.LastTimeUsedComparator();
        private chatday.UsageTimeComparator mUsageTimeComparator = new chatday.UsageTimeComparator();
        private chatday.AppNameComparator mAppLabelComparator;
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new chatday.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder = new chatday.AppViewHolder();
                ...
                // and the ImageView.
                holder = (chatday.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = chatday.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharechatday=getView().findViewById(R.id.sharechatday);
        sharechatday.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ListView listView = (ListView) getView().findViewById(R.id.comunication_list);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CombinedChart Chart = (CombinedChart) getView().findViewById(R.id.chart_chatday);
        ...
        return inflater.inflate(R.layout.fragment_chatday, container, false);
    }
