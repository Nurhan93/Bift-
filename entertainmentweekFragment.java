 ...
 * {@link entertainmentweekFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link entertainmentweekFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class entertainmentweekFragment extends Fragment implements OnItemSelectedListener {
    ...
    private entertainmentweekFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    private float totalDays;
    TextView dailyaveragerunyear;
    ImageButton shareentertainmentweek;
    ...
    public entertainmentweekFragment() {
     ...
     * @return A new instance of fragment entertainmentweekFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static entertainmentweekFragment newInstance(String param1, String param2) {
        entertainmentweekFragment fragment = new entertainmentweekFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private entertainmentweekFragment.LastTimeUsedComparator mLastTimeUsedComparator = new entertainmentweekFragment.LastTimeUsedComparator();
        private entertainmentweekFragment.UsageTimeComparator mUsageTimeComparator = new entertainmentweekFragment.UsageTimeComparator();
        private entertainmentweekFragment.AppNameComparator mAppLabelComparator;
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new entertainmentweekFragment.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            entertainmentweekFragment.AppViewHolder holder;
            ...
            if (convertView == null) {
                ...
                holder = new entertainmentweekFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (entertainmentweekFragment.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = entertainmentweekFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        shareentertainmentweek=getView().findViewById(R.id.shareentertainmentweek);
        shareentertainmentweek.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        dailyaveragerunyear=getView().findViewById(R.id.dailyaverageentweek);
        ...
        ListView listView = (ListView) getView().findViewById(R.id.entertainment_list2);
        mAdapter = new entertainmentweekFragment.UsageStatsAdapter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_entertainmentweek);
        ...
        return inflater.inflate(R.layout.fragment_entertainmentweek, container, false);
    }
