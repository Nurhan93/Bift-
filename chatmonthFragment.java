 ...
 * {@link chatmonthFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link chatmonthFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class chatmonthFragment extends Fragment implements OnItemSelectedListener {
    ...
    private chatmonthFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    ImageButton sharechatmonth;
     ...
     * @return A new instance of fragment chatmonthFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static chatmonthFragment newInstance(String param1, String param2) {
        chatmonthFragment fragment = new chatmonthFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private chatmonthFragment.LastTimeUsedComparator mLastTimeUsedComparator = new LastTimeUsedComparator();
        private chatmonthFragment.UsageTimeComparator mUsageTimeComparator = new UsageTimeComparator();
        private chatmonthFragment.AppNameComparator mAppLabelComparator;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                // and the ImageView.
                holder = (chatmonthFragment.AppViewHolder) convertView.getTag();
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharechatmonth=getView().findViewById(R.id.sharechatmonth);
        sharechatmonth.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ListView listView = (ListView) getView().findViewById(R.id.comunication_list1);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_chatmonth);
        ...
        return inflater.inflate(R.layout.fragment_chatmonth, container, false);
    }
