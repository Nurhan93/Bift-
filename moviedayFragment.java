 ...
 * {@link moviedayFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link moviedayFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class moviedayFragment extends Fragment implements OnItemSelectedListener {
    ...
    private moviedayFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    ImageButton sharemovieday;
     ...
     * @return A new instance of fragment moviedayFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static moviedayFragment newInstance(String param1, String param2) {
        moviedayFragment fragment = new moviedayFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private moviedayFragment.LastTimeUsedComparator mLastTimeUsedComparator = new LastTimeUsedComparator();
        private moviedayFragment.UsageTimeComparator mUsageTimeComparator = new UsageTimeComparator();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharemovieday=getView().findViewById(R.id.sharemovieday);
        sharemovieday.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ListView listView = (ListView) getView().findViewById(R.id.movie_list);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CombinedChart Chart = (CombinedChart) getView().findViewById(R.id.chart_movieday);
        ...
        return inflater.inflate(R.layout.fragment_movieday, container, false);
    }
