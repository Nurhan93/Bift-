...
public class Sleep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharesleep=findViewById(R.id.sharesleep);
        ImageButton back8=(ImageButton)findViewById(R.id.Back8);
        final Context context=this;
        back8.setImageResource(R.drawable.ic_arrow_forward_black_24dp);
        ...
        mViewPager = (ViewPager) findViewById(R.id.container7);
...
// for sleep tabs fragment
        fragmentTransaction=getSupportFragmentManager().beginTransaction();
        fragmentTransaction.add(R.id.container7, new sleepdayFragment());
        fragmentTransaction.commit();
        getSupportActionBar().setTitle("Day"); // for day

        fragmentTransaction=getSupportFragmentManager().beginTransaction();
        fragmentTransaction.add(R.id.container7, new sleepmonthFragment());
        fragmentTransaction.commit();
        getSupportActionBar().setTitle("Month"); // for month

        fragmentTransaction=getSupportFragmentManager().beginTransaction();
        fragmentTransaction.add(R.id.container7, new sleepweekFragment());
        fragmentTransaction.commit();
        getSupportActionBar().setTitle("Week"); // for week

        fragmentTransaction=getSupportFragmentManager().beginTransaction();
        fragmentTransaction.add(R.id.container7, new sleepyearFragment());
        fragmentTransaction.commit();
    ...
    public void back8 (View v) { // for the back button
        Intent mainpage= new Intent(this,MainPage.class);
        startActivity(mainpage);
    }

    public void sharesleep(View view) { // share button for sleep
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 3:
                    sleepyearFragment sleepyearFragment = new sleepyearFragment();
                    return sleepyearFragment;
                default:
                    return null;
            }
        }
