 ...
 * {@link gamesyearFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link gamesyearFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class gamesyearFragment extends Fragment implements OnItemSelectedListener  {
    ...
    private gamesyearFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    ImageButton sharegamesyear;
     ...
     * @return A new instance of fragment gamesyearFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static gamesyearFragment newInstance(String param1, String param2) {
        gamesyearFragment fragment = new gamesyearFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private gamesyearFragment.LastTimeUsedComparator mLastTimeUsedComparator = new LastTimeUsedComparator();
        private gamesyearFragment.UsageTimeComparator mUsageTimeComparator = new UsageTimeComparator();
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder = new gamesyearFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (gamesyearFragment.AppViewHolder) convertView.getTag();
            }
    ...
    private class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = gamesyearFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharegamesyear=getView().findViewById(R.id.sharegamesyear);
        sharegamesyear.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        dailyaveragerunyear=getView().findViewById(R.id.dailyaveragegamesyear);
        ...
        // for bar chart
        mchart=getView().findViewById(R.id.chart_gamesyear);
...
// for hours
        ...
        ListView listView = (ListView) getView().findViewById(R.id.games_list3);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_gamesyear, container, false);
    }
