 ...
 * Use the {@link movieyearFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class movieyearFragment extends Fragment implements OnItemSelectedListener{
    ...
    private movieyearFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    private float totalDays;
    TextView dailyaveragerunyear;
    ImageButton sharemovieyear;
     ...
     * @return A new instance of fragment movieyearFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static movieyearFragment newInstance(String param1, String param2) {
        movieyearFragment fragment = new movieyearFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private movieyearFragment.LastTimeUsedComparator mLastTimeUsedComparator = new movieyearFragment.LastTimeUsedComparator();
        private movieyearFragment.UsageTimeComparator mUsageTimeComparator = new movieyearFragment.UsageTimeComparator();
        private movieyearFragment.AppNameComparator mAppLabelComparator;
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new movieyearFragment.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            movieyearFragment.AppViewHolder holder;
            ...
            if (convertView == null) {
                ...
                holder = new movieyearFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (movieyearFragment.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = movieyearFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharemovieyear=getView().findViewById(R.id.sharemovieyear);
        sharemovieyear.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        dailyaveragerunyear=getView().findViewById(R.id.dailyaveragemonthmovieyear);
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_movieyear);
// for hours
        ...
        chart.setData(data);
        chart.setDescription("Movie_year");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_movieyear, container, false);
    }
