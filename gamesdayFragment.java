 ...
 * {@link gamesdayFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link gamesdayFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class gamesdayFragment extends Fragment implements OnItemSelectedListener  {
    ...
    private gamesdayFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    ImageButton sharegamesday;
     ...
     * @return A new instance of fragment gamesdayFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static gamesdayFragment newInstance(String param1, String param2) {
        gamesdayFragment fragment = new gamesdayFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private gamesdayFragment.LastTimeUsedComparator mLastTimeUsedComparator = new LastTimeUsedComparator();
        private gamesdayFragment.UsageTimeComparator mUsageTimeComparator = new UsageTimeComparator();
        private gamesdayFragment.AppNameComparator mAppLabelComparator;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                // and the ImageView.
                holder = (gamesdayFragment.AppViewHolder) convertView.getTag();
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharegamesday=getView().findViewById(R.id.sharegamesday);
        sharegamesday.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CombinedChart Chart = (CombinedChart) getView().findViewById(R.id.chart_gamesday);
        ...
        return inflater.inflate(R.layout.fragment_gamesday, container, false);
    }
