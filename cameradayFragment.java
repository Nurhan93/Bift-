 ...
 * {@link cameradayFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link cameradayFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class cameradayFragment extends Fragment implements OnItemSelectedListener {
    ...
    private cameradayFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;

    ImageButton sharecameraday;
     ...
     * @return A new instance of fragment cameradayFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static cameradayFragment newInstance(String param1, String param2) {
        cameradayFragment fragment = new cameradayFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private cameradayFragment.LastTimeUsedComparator mLastTimeUsedComparator = new cameradayFragment.LastTimeUsedComparator();
        private cameradayFragment.UsageTimeComparator mUsageTimeComparator = new cameradayFragment.UsageTimeComparator();
        private cameradayFragment.AppNameComparator mAppLabelComparator;
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new cameradayFragment.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            cameradayFragment.AppViewHolder holder;
            ...
            if (convertView == null) {
                ...
                holder = new cameradayFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (cameradayFragment.AppViewHolder) convertView.getTag();
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharecameraday=getView().findViewById(R.id.sharecameraday);
        sharecameraday.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ListView listView = (ListView) getView().findViewById(R.id.camera_list);
        mAdapter = new cameradayFragment.UsageStatsAdapter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CombinedChart Chart = (CombinedChart) getView().findViewById(R.id.chart_cameraday);
        ...
        return inflater.inflate(R.layout.fragment_cameraday, container, false);
