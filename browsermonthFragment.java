 ...
 * {@link browsermonthFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link browsermonthFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class browsermonthFragment extends Fragment implements OnItemSelectedListener  {
    ...
    private browsermonthFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    ImageButton sharebroswermonth;
     ...
     * @return A new instance of fragment browsermonthFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static browsermonthFragment newInstance(String param1, String param2) {
        browsermonthFragment fragment = new browsermonthFragment();
    ...
    public static class LastTimeUsedComparator extends gamesdayFragment.LastTimeUsedComparator implements Comparator<UsageStats> {
        @Override
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private browsermonthFragment.LastTimeUsedComparator mLastTimeUsedComparator = new LastTimeUsedComparator();
        private browsermonthFragment.UsageTimeComparator mUsageTimeComparator = new UsageTimeComparator();
        private browsermonthFragment.AppNameComparator mAppLabelComparator;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                // and the ImageView.
                holder = (browsermonthFragment.AppViewHolder) convertView.getTag();
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharebroswermonth=getView().findViewById(R.id.sharebroswermonth);
        sharebroswermonth.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ListView listView = (ListView) getView().findViewById(R.id.broswer_list);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_broswermonth);

        BarChart data= new BarChart(getContext());

        BarData chartBarData = chart.getBarData();
        ...
        return inflater.inflate(R.layout.fragment_browsermonth, container, false);
    }
