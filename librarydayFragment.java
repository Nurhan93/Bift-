 ...
 * {@link librarydayFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link librarydayFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class librarydayFragment extends Fragment implements OnItemSelectedListener  {
    ...
    private librarydayFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    ImageButton sharelibraryday;
     ...
     * @return A new instance of fragment librarydayFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static librarydayFragment newInstance(String param1, String param2) {
        librarydayFragment fragment = new librarydayFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private librarydayFragment.LastTimeUsedComparator mLastTimeUsedComparator = new librarydayFragment.LastTimeUsedComparator();
        private librarydayFragment.UsageTimeComparator mUsageTimeComparator = new librarydayFragment.UsageTimeComparator();
        private librarydayFragment.AppNameComparator mAppLabelComparator;
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new librarydayFragment.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            librarydayFragment.AppViewHolder holder;
            ...
            if (convertView == null) {
                ...
                holder = new librarydayFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (librarydayFragment.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = librarydayFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharelibraryday=getView().findViewById(R.id.sharelibraryday);
        sharelibraryday.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mAdapter = new librarydayFragment.UsageStatsAdapter();
        ...
        CombinedChart Chart = (CombinedChart) getView().findViewById(R.id.chart_libraryday);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_libraryday, container, false);
    }
// for progress bar time
