 ...
 * {@link gamesweekFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link gamesweekFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class gamesweekFragment extends Fragment implements OnItemSelectedListener   {
    ...
    private gamesweekFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    private float totalDays;
    TextView dailyaveragerunyear;
    ImageButton sharegamesweek;
     ...
     * @return A new instance of fragment gamesweekFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static gamesweekFragment newInstance(String param1, String param2) {
        gamesweekFragment fragment = new gamesweekFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private gamesmonthFragment.LastTimeUsedComparator mLastTimeUsedComparator = new gamesmonthFragment.LastTimeUsedComparator();
        private gamesmonthFragment.UsageTimeComparator mUsageTimeComparator = new gamesmonthFragment.UsageTimeComparator();
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new gamesmonthFragment.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder =  new gamesmonthFragment.AppViewHolder();
    ...
    private class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = gamesweekFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharegamesweek=getView().findViewById(R.id.sharegamesweek);
        sharegamesweek.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        dailyaveragerunyear=getView().findViewById(R.id.dailyaveragegamesweek);
        ...
        ListView listView = (ListView) getView().findViewById(R.id.games_list2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_gamesweek);
        ...
        return inflater.inflate(R.layout.fragment_gamesweek, container, false);
    }
