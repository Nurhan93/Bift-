 ...
 * {@link libraryyearFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link libraryyearFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class libraryyearFragment extends Fragment implements OnItemSelectedListener  {
    ...
    private libraryyearFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    TextView dailyaverage;
    private float totalDays;
    ImageButton sharelibraryyear;
     ...
     * @return A new instance of fragment libraryyearFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static libraryyearFragment newInstance(String param1, String param2) {
        libraryyearFragment fragment = new libraryyearFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private libraryyearFragment.LastTimeUsedComparator mLastTimeUsedComparator = new libraryyearFragment.LastTimeUsedComparator();
        private libraryyearFragment.UsageTimeComparator mUsageTimeComparator = new libraryyearFragment.UsageTimeComparator();
        private libraryyearFragment.AppNameComparator mAppLabelComparator;
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new libraryyearFragment.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            libraryyearFragment.AppViewHolder holder;
            ...
            if (convertView == null) {
                ...
                holder = new libraryyearFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (libraryyearFragment.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = libraryyearFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharelibraryyear=getView().findViewById(R.id.sharelibraryyear);
        sharelibraryyear.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        dailyaverage=getView().findViewById(R.id.dailyaveragelibraryyear);
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_libraryear);
// for hours
        ...
        ListView listView = (ListView) getView().findViewById(R.id.library_list3);
        mAdapter = new libraryyearFragment.UsageStatsAdapter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_libraryyear, container, false);
    }
