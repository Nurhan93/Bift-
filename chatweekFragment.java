 ...
 * {@link chatweekFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link chatweekFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class chatweekFragment extends Fragment implements OnItemSelectedListener {
    ...
    private chatweekFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    ImageButton sharechatweek;
     ...
     * @return A new instance of fragment chatweekFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static chatweekFragment newInstance(String param1, String param2) {
        chatweekFragment fragment = new chatweekFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private chatweekFragment.LastTimeUsedComparator mLastTimeUsedComparator = new chatweekFragment.LastTimeUsedComparator();
        private chatweekFragment.UsageTimeComparator mUsageTimeComparator = new chatweekFragment.UsageTimeComparator();
        private chatweekFragment.AppNameComparator mAppLabelComparator;
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new chatweekFragment.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            chatweekFragment.AppViewHolder holder;
            ...
            if (convertView == null) {
                ...
                holder = new chatweekFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (chatweekFragment.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = chatmonthFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharechatweek=getView().findViewById(R.id.sharechatweek);
        sharechatweek.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mAdapter = new chatweekFragment.UsageStatsAdapter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_chatweek);
        ...
        return inflater.inflate(R.layout.fragment_chatweek, container, false);
    }
