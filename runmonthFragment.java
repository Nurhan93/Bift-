 ...
 * {@link runmonthFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link runmonthFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class runmonthFragment extends Fragment {

    TextView dailyaveragerunmonth;
     ...
     * @return A new instance of fragment runmonthFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static runmonthFragment newInstance(String param1, String param2) {
        runmonthFragment fragment = new runmonthFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        dailyaveragerunmonth=getView().findViewById(R.id.dailyaveragerunmonth);
        dailyaveragerunmonth.setOnClickListener(new View.OnClickListener() {
            @SuppressLint({"SetTextI18n", "DefaultLocale"})
            @Override
            public void onClick(View v) {
                dailyaveragerunmonth.setText("Total overall consumption time: "
                        + String.format("%.1f", totalDays) + " Months");
            }
        });
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_runmonth);
        ...
        return inflater.inflate(R.layout.fragment_runmonth, container, false);
    }
