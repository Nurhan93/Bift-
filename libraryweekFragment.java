 ...
 * {@link libraryweekFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link libraryweekFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class libraryweekFragment extends Fragment implements OnItemSelectedListener {
    ...
    private libraryweekFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    TextView dailyaverage;
    private float totalDays;
    ImageButton sharelibraryweek;
     ...
     * @return A new instance of fragment libraryweekFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static libraryweekFragment newInstance(String param1, String param2) {
        libraryweekFragment fragment = new libraryweekFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private libraryweekFragment.LastTimeUsedComparator mLastTimeUsedComparator = new libraryweekFragment.LastTimeUsedComparator();
        private libraryweekFragment.UsageTimeComparator mUsageTimeComparator = new libraryweekFragment.UsageTimeComparator();
        private libraryweekFragment.AppNameComparator mAppLabelComparator;
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new libraryweekFragment.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            libraryweekFragment.AppViewHolder holder;
            ...
            if (convertView == null) {
                ...
                holder = new libraryweekFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (libraryweekFragment.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = libraryweekFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharelibraryweek=getView().findViewById(R.id.sharelibraryweek);
        sharelibraryweek.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        dailyaverage=getView().findViewById(R.id.dailyaveragelibraryweek);
        ...
        ListView listView = (ListView) getView().findViewById(R.id.library_list2);
        mAdapter = new libraryweekFragment.UsageStatsAdapter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_libraryweek);
        ...
        return inflater.inflate(R.layout.fragment_libraryweek, container, false);
    }
