 ...
 * {@link cameramonthFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link cameramonthFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class cameramonthFragment extends Fragment implements OnItemSelectedListener{
    ...
    private cameramonthFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    private float totalDays;
    TextView dailyaveragerunyear;
    ImageButton sharecameramonth;
     ...
     * @return A new instance of fragment cameramonthFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static cameramonthFragment newInstance(String param1, String param2) {
        cameramonthFragment fragment = new cameramonthFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private cameramonthFragment.LastTimeUsedComparator mLastTimeUsedComparator = new cameramonthFragment.LastTimeUsedComparator();
        private cameramonthFragment.UsageTimeComparator mUsageTimeComparator = new cameramonthFragment.UsageTimeComparator();
        private cameramonthFragment.AppNameComparator mAppLabelComparator;
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new cameramonthFragment.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            cameramonthFragment.AppViewHolder holder;
            ...
            if (convertView == null) {
                ...
                holder = new cameramonthFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (cameramonthFragment.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = cameradayFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharecameramonth=getView().findViewById(R.id.sharecameramonth);
        sharecameramonth.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        // for data usage
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mUsageStatsManager = (UsageStatsManager) Objects.requireNonNull(getActivity()).getSystemService(Context.USAGE_STATS_SERVICE);
        }
        mInflater = (LayoutInflater)getActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mPm = getActivity().getPackageManager();

        ListView listView = (ListView) getView().findViewById(R.id.camera_list1);
        mAdapter = new cameramonthFragment.UsageStatsAdapter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_cameramonth);
        ...
        return inflater.inflate(R.layout.fragment_cameramonth, container, false);
    }
