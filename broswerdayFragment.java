 ...
 * {@link broswerdayFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link broswerdayFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class broswerdayFragment extends Fragment implements OnItemSelectedListener {
...
// for categoriez the app storage
    ...
    ProgressBar chart_br;
    TimePicker clock;
    ImageButton sharebroswerday;
     ...
     * @return A new instance of fragment broswerdayFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static broswerdayFragment newInstance(String param1, String param2) {
        broswerdayFragment fragment = new broswerdayFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        UsageStatsAdapter() {
            ...
            mPackageStats.addAll(Objects.requireNonNull(map).values());
...
class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharebroswerday=getView().findViewById(R.id.sharebroswerday);
        sharebroswerday.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_broswerday, container, false);
    }
