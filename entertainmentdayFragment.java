 ...
 * {@link entertainmentdayFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link entertainmentdayFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class entertainmentdayFragment extends Fragment implements OnItemSelectedListener  {
    ...
    private entertainmentdayFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    ImageButton shareentertainmentday;
    ...
    public entertainmentdayFragment() {
     ...
     * @return A new instance of fragment entertainmentdayFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static entertainmentdayFragment newInstance(String param1, String param2) {
        entertainmentdayFragment fragment = new entertainmentdayFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            entertainmentdayFragment.AppViewHolder holder;
            ...
            if (convertView == null) {
                ...
                holder = new entertainmentdayFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (entertainmentdayFragment.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = entertainmentdayFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        shareentertainmentday=getView().findViewById(R.id.shareentertainmentday);
        shareentertainmentday.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mAdapter = new entertainmentdayFragment.UsageStatsAdapter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CombinedChart Chart = (CombinedChart) getView().findViewById(R.id.chart_entertainmentday);
        ...
        return inflater.inflate(R.layout.fragment_entertainmentday, container, false);
    }
