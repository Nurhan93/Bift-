 ...
 * {@link rundayFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link rundayFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class rundayFragment extends Fragment {
    TextView dailyaveragerun;
     ...
     * @return A new instance of fragment rundayFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static rundayFragment newInstance(String param1, String param2) {
        rundayFragment fragment = new rundayFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dailyaveragerun=getView().findViewById(R.id.dailyaveragerunday);
        dailyaveragerun.setOnClickListener(new View.OnClickListener() {
            @SuppressLint({"SetTextI18n", "DefaultLocale"})
            @Override
            public void onClick(View v) {
                dailyaveragerun.setText("Total overall consumption time: "
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CombinedChart Chart = (CombinedChart) getView().findViewById(R.id.chart_runday);
        ...
        return inflater.inflate(R.layout.fragment_runday, container, false);
    }
