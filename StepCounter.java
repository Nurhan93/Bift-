...
class StepCounter {
    ...
    public StepCounter(ReactContext mReactContext, stepsdayFragment googleFitManager, Activity activity) {
    ...
    private void registerFitnessDataListener(DataSource dataSource, DataType dataType) {
        ...
        Fitness.SensorsApi.add(googleFitManager.getGoogleApiClient(), request, (OnDataPointListener) this)
