 ...
 * {@link librarymonthFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link librarymonthFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class librarymonthFragment extends Fragment implements OnItemSelectedListener {

    // for categoriez the app storage
    public final static String GOOGLE_URL= "https://play.google.com/store/books"; // url for the categories i used in library
    ...
    private librarymonthFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    TextView dailyaverage;
    private float totalDays;
    ImageButton sharelibrarymonth;
     ...
     * @return A new instance of fragment librarymonthFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static librarymonthFragment newInstance(String param1, String param2) {
        librarymonthFragment fragment = new librarymonthFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private librarymonthFragment.LastTimeUsedComparator mLastTimeUsedComparator = new librarymonthFragment.LastTimeUsedComparator();
        private librarymonthFragment.UsageTimeComparator mUsageTimeComparator = new librarymonthFragment.UsageTimeComparator();
        private librarymonthFragment.AppNameComparator mAppLabelComparator;
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new librarymonthFragment.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            librarymonthFragment.AppViewHolder holder;
            ...
            if (convertView == null) {
                ...
                holder = new librarymonthFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (librarymonthFragment.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = librarymonthFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharelibrarymonth=getView().findViewById(R.id.sharelibrarymonth);
        sharelibrarymonth.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        // for daily average
        dailyaverage=getView().findViewById(R.id.dailyaveragelibrarymonth);
        ...
        ListView listView = (ListView) getView().findViewById(R.id.library_list1);
        mAdapter = new librarymonthFragment.UsageStatsAdapter();
        ...
        if (android.os.Build.VERSION.SDK_INT>= 21){
            ...
            window.setStatusBarColor(this.getResources().getColor(R.color.shadesofred));
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_librarymonth);
        ...
        return inflater.inflate(R.layout.fragment_librarymonth, container, false);
    }
