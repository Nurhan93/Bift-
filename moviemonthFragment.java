 ...
 * {@link moviemonthFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link moviemonthFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class moviemonthFragment extends Fragment implements OnItemSelectedListener {
    ...
    private moviemonthFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    private float totalDays;
    TextView dailyaveragemovie;
    ImageButton sharemoviemonth;
     ...
     * @return A new instance of fragment moviemonthFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static moviemonthFragment newInstance(String param1, String param2) {
        moviemonthFragment fragment = new moviemonthFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private moviemonthFragment.LastTimeUsedComparator mLastTimeUsedComparator = new LastTimeUsedComparator();
        private moviemonthFragment.UsageTimeComparator mUsageTimeComparator = new UsageTimeComparator();
        private moviemonthFragment.AppNameComparator mAppLabelComparator;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                // and the ImageView.
                holder = (moviemonthFragment.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = moviemonthFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharemoviemonth=getView().findViewById(R.id.sharemoviemonth);
        sharemoviemonth.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        dailyaveragemovie=getView().findViewById(R.id.dailyaveragemonthmovie);
        dailyaveragemovie.setOnClickListener(new View.OnClickListener() {
            @SuppressLint("SetTextI18n")
            @Override
            public void onClick(View v) {
                dailyaveragemovie.setText("Total overall consumption time: "
        ...
        ListView listView = (ListView) getView().findViewById(R.id.movie_list1);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_moviemonth);
        ...
        return inflater.inflate(R.layout.fragment_moviemonth, container, false);
    }
