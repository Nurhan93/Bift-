 ...
 * {@link movieweekFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link movieweekFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class movieweekFragment extends Fragment implements OnItemSelectedListener {

    // for categoriez the app storage
    public final static String GOOGLE_URL= "https://play.google.com/store/movies"; // url for the categories i used in movie
     ...
     * @return A new instance of fragment movieweekFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static movieweekFragment newInstance(String param1, String param2) {
        movieweekFragment fragment = new movieweekFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private movieweekFragment.LastTimeUsedComparator mLastTimeUsedComparator = new LastTimeUsedComparator();
        private movieweekFragment.UsageTimeComparator mUsageTimeComparator = new movieweekFragment.UsageTimeComparator();
        private movieweekFragment.AppNameComparator mAppLabelComparator;
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new movieweekFragment.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            movieweekFragment.AppViewHolder holder;
            ...
            if (convertView == null) {
                ...
                holder = new movieweekFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (movieweekFragment.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = movieweekFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharemovieweek=getView().findViewById(R.id.sharemovieweek);
        sharemovieweek.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        dailyaveragerunyear=getView().findViewById(R.id.dailyaveragemovieweek);
        ...
        ListView listView = (ListView) getView().findViewById(R.id.movie_list2);
        mAdapter = new movieweekFragment.UsageStatsAdapter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_movieweek);
        ...
        return inflater.inflate(R.layout.fragment_movieweek, container, false);
    }
