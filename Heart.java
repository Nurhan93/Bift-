...
FragmentTransaction fragmentTransaction;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shareheart=findViewById(R.id.shareheart);
        ImageButton back5=(ImageButton)findViewById(R.id.Back5);
        final Context context=this;
        back5.setImageResource(R.drawable.ic_arrow_forward_black_24dp);
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.tabs8);
        tabLayout.addTab(tabLayout.newTab().setText("Day"));
        tabLayout.addTab(tabLayout.newTab().setText("Week"));
        tabLayout.addTab(tabLayout.newTab().setText("Month"));
        tabLayout.addTab(tabLayout.newTab().setText("Year"));
// for heart 4 tabs fragments
        fragmentTransaction=getSupportFragmentManager().beginTransaction();
        fragmentTransaction.add(R.id.container4, new heartdayFragment());
        fragmentTransaction.commit();
        getSupportActionBar().setTitle("Day"); // for day

        fragmentTransaction=getSupportFragmentManager().beginTransaction();
        fragmentTransaction.add(R.id.container4, new heartmonthFragment());
        fragmentTransaction.commit();
        getSupportActionBar().setTitle("Month"); // for month

        fragmentTransaction=getSupportFragmentManager().beginTransaction();
        fragmentTransaction.add(R.id.container4, new heartweekFragment());
        fragmentTransaction.commit();
        getSupportActionBar().setTitle("Week"); // for week

        fragmentTransaction=getSupportFragmentManager().beginTransaction();
        fragmentTransaction.add(R.id.container4, new heartyearFragment());
        fragmentTransaction.commit();
    ...
    public void back5 (View v) { // for the back button
        Intent mainpage= new Intent(this,MainPage.class);
        startActivity(mainpage);
    }

    public void shareheart (View view) { // for share heart button
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 3:
                    heartyearFragment heartyearFragment = new heartyearFragment();
                    return heartyearFragment;
                default:
                    return null;
            }
        }
