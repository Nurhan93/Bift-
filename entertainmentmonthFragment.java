 ...
 * {@link entertainmentmonthFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link entertainmentmonthFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class entertainmentmonthFragment extends Fragment implements OnItemSelectedListener {
    ...
    private entertainmentmonthFragment.UsageStatsAdapter mAdapter;
    private PackageManager mPm;
    private float totalDays;
    TextView dailyaveragerunyear;
    ImageButton shareentertainmentmonth;
    ...
    public entertainmentmonthFragment() {
     ...
     * @return A new instance of fragment entertainmentmonthFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static entertainmentmonthFragment newInstance(String param1, String param2) {
        entertainmentmonthFragment fragment = new entertainmentmonthFragment();
    ...
    class UsageStatsAdapter extends BaseAdapter {
        ...
        private entertainmentdayFragment.LastTimeUsedComparator mLastTimeUsedComparator = new entertainmentdayFragment.LastTimeUsedComparator();
        private entertainmentdayFragment.UsageTimeComparator mUsageTimeComparator = new entertainmentdayFragment.UsageTimeComparator();
        private entertainmentdayFragment.AppNameComparator mAppLabelComparator;
        ...
        UsageStatsAdapter() {
            ...
            // Sort list
            mAppLabelComparator = new entertainmentdayFragment.AppNameComparator(mAppLabelMap);
            sortList();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            entertainmentmonthFragment.AppViewHolder holder;
            ...
            if (convertView == null) {
                ...
                holder = new entertainmentmonthFragment.AppViewHolder();
                ...
                // and the ImageView.
                holder = (entertainmentmonthFragment.AppViewHolder) convertView.getTag();
            }
    ...
    class FetchCategoryTask extends AsyncTask<Void, Void, Void> {
        ...
        private final String TAG = entertainmentmonthFragment.FetchCategoryTask.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        shareentertainmentmonth=getView().findViewById(R.id.shareentertainmentmonth);
        shareentertainmentmonth.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        dailyaveragerunyear=getView().findViewById(R.id.dailyaverageenter);
        ...
        ListView listView = (ListView) getView().findViewById(R.id.entertainment_list1);
        mAdapter = new entertainmentmonthFragment.UsageStatsAdapter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BarChart chart = (BarChart) getView().findViewById(R.id.chart_entertainmentmonth);
        ...
        return inflater.inflate(R.layout.fragment_entertainmentmonth, container, false);
    }
