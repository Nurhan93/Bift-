 ...
 * {@link caryearFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link caryearFragment#newInstance} factory method to
...
public class caryearFragment extends Fragment {
    ...
    TextView dailyaveragecaryear;
    ImageButton sharecaryear;
     ...
     * @return A new instance of fragment caryearFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static caryearFragment newInstance(String param1, String param2) {
        caryearFragment fragment = new caryearFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharecaryear=getView().findViewById(R.id.sharecaryear);
        sharecaryear.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        dailyaveragecaryear=getView().findViewById(R.id.dailyaveragemonthcaryear);
        dailyaveragecaryear.setOnClickListener(new View.OnClickListener() {
            @SuppressLint({"DefaultLocale", "SetTextI18n"})
            @Override
            public void onClick(View v) {
                dailyaveragecaryear.setText("Total overall consumption time: "
                        + String.format("%.1f", totalDays) + " Years");
            }
        });

        BarChart chart = (BarChart) getView().findViewById(R.id.chart_caryear);
// for hours
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_caryear, container, false);
    }
